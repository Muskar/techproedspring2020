...
public class Lambda14 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		IntStream.rangeClosed(0, 10).forEach(System.out::print); // For rangeClosed(a, b) ==> a is inclusive, b is inclusive
		...
		IntStream.iterate(1, t->t+2).limit(5).forEach(System.out::print);// For IntStream to update the elements use iterate()
		...
		//Print the first 5 power of 2 on the console ==> 2, 2x2=4, 2x2x2=8, 2x2x2x2=16, 2x2x2x2x2=32 ==> 2 4 8 16 32 
